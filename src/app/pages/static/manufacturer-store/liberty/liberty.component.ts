...
export class LibertyComponent implements OnInit {
  ...
  constructor(@Inject(PLATFORM_ID) platformId, private _router: Router, private _activatedRoute: ActivatedRoute, private _libertyService: LibertyService, private title: Title, private meta: Meta) {
  ...
  ngOnInit() {
    ...
    let metaDesc = "Shop online from Moglix Manufacturer store at best prices now! Moglix is a one-stop shop for buying genuine products online. Free Shipping & COD available.";

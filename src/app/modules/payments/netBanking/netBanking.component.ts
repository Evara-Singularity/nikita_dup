...
export class NetBankingComponent implements OnInit {
    ...
    pay(data, valid) {
        ...
        this._commonService.isBrowser && this.initPaymentStartAnalytics(shippingInformation, addressList);
        this._commonService.isBrowser && this._analytics.sendAdobeOrderRequestTracking(newdata, `pay-initiated:net banking`);

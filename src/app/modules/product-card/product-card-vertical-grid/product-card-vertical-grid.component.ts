...
@Component({
  selector: 'product-card-vertical-grid',
  templateUrl: './product-card-vertical-grid.component.html',
  styleUrls: ['./product-card-vertical-grid.component.scss']
})
export class ProductCardVericalGridComponent implements OnInit {

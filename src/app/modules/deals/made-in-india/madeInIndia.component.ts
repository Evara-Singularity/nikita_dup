...
export class MadeInIndiaComponent {
  ...
  setMetas() {
    ...
    this.meta.addTag({
      name: "description", content: "Celebrate India's pride with best Indian brands and products manufactured exclusively in India. Explore the Made in India range at Moglix.com.",
    });
  }

...
export class NewYearComponent {
  ...
  setMetas() {
    this.title.setTitle("New Year Offers and Deals - Moglix.com");
    this.meta.addTag({
      name: "description", content: "Deals that make your New Year celebrations awesome. Explore wide range of new year offers and enjoy amazing discounts on industrial supplies.",
    });
  }
  ...
  getFreshData3() {
    ...
    this.route.data.subscribe(
      ...
      (error) => {
        console.log("NewYearComponent API data catch error", error);
      }
    );
  }

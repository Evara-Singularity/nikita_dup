...
@Component({
  selector: 'product-card-horizontal-grid',
  templateUrl: './product-card-horizontal-grid.component.html',
  styleUrls: ['./product-card-horizontal-grid.component.scss']
})
export class ProductCardHorizontalGridComponent implements OnInit {

...
export class OrderFailureComponent {
    ...
    API: {}
    queryParams: {};
    constructor(private _router: Router, public footerService: FooterService, private _activatedRoute: ActivatedRoute, private _localAuthService: LocalAuthService, private _cartService: CartService) {
    }

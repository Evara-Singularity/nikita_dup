...
export const product = {
    ...
    min_emi_text:"EMI बैंकों में न्यूनतम रु. 3000 की खरीद पर उपलब्ध है",
    ...
    by: 'द्वारा',
    enter_the_req_qty: 'आवश्यक मात्रा दर्ज करें',
    ...
    city: 'सिटी',
    i_dont_know_my_pincode: "मुझे अपना पिनकोड नहीं पता",
    ...
    top: 'शीर्ष',
    price_range_of: ' प्राइस रेंज ऑफ',
    categories_of: ' श्रेणियां ऑफ',
    in_price_range: 'की प्राइस रेंज में',
    of_users_prefer: 'उपयोगकर्ता की पसंद',
    in_other_price_range: 'अन्य प्राइस रेंज में',
    ...
    on: 'पर',
    moglix_offers_quality_genuine: 'मोग्लिक्स प्रदान करता है बेहतर गुणवत्ता और वास्तविकता वाले ',
    from_renowned_brand: 'एक नामी ब्रांड से जिसका नाम है',
    ...
    buy_online: 'उत्पाद ऑनलाइन भारत में सबसे अच्छे दामों पर',
    shop_online: ' उत्पाद अब सबसे अच्छी कीमत पर!',
    brand_title: 'उत्पादों के लिए ऑनलाइन खरीदारी करें। पूरे भारत में मुफ्त डिलीवरी और सीओडी विकल्प!',
    viewMore:"देखें और",
    ...
    view_more: 'और देखें',
    online_at_best_price_india: 'ऑनलाइन भारत में सर्वोत्तम मूल्य पर', 
    related_brand_categories: 'संबंधित ब्रांड कैटेगरी',
    Shop_online_for: 'ऑनलाइन शॉपिंग करें',
    at_best_prices_now: 'अब सबसे अच्छी कीमत पर!',
